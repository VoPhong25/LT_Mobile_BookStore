...
public class DisplayProductsActivity extends AppCompatActivity {
    ...
    TextView tv_rating,product_name,Product_price,Product_discount,Product_author,Product_pieces,Product_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Product_author = findViewById(R.id.display_tv_author);
        ...
        Product_author.setText(p.getAuthor());
        ...
        add_to_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String author = Product_author.getText().toString();
                ...
                Products ppp = new Products(image,name,priceAfter,author,rating,quantity);
                ...
                alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Toast.makeText(DisplayProductsActivity.this, "Add Success", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
                alertDialog.show();
